...
import {
  ...
  CalendarBlank, Heart, MusicNote, Palette, CheckCircle, WarningCircle,
    ...
    >
      ...
      {isError && (
        <button
          ...
          title="Retry upload"
        >
          <ArrowCounterClockwise size={10} className="text-white" />
        </button>
      )}
      ...
      <div className="bg-transparent border-b border-black/8 dark:border-white/10 p-6">
        ...
        {media.length === 0 && (
          <label className="mt-4 w-full flex flex-col items-center gap-3 py-8 border-2 border-dashed border-black/10 dark:border-white/10 rounded-2xl cursor-pointer hover:border-blue-300 dark:hover:border-blue-700 hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition-all group">
            <div className="flex items-center gap-3">
              ...
              <FilmSlate size={20} className="text-purple-500" />
              </div>
            </div>
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-black/5 dark:border-white/5 flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {submitting ? <SpinnerGap size={15} className="animate-spin" /> : <PaperPlaneTilt size={15} />}
            </motion.button>
          </div>
        </div>
      </div>
