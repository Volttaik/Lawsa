...
import { CheckCircle, SealCheck, Lightning, Palette, TrendUp, Star, Lock, ArrowRight, SpinnerGap, Shield } from "@phosphor-icons/react";
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-blue-400 text-sm font-medium">LAWSA Premium</span>
          </div>
