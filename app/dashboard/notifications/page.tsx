    ...
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      {loading ? (
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
          className="bg-white dark:bg-gray-900 rounded-2xl border border-black/10 dark:border-white/10 shadow-card p-14 text-center">
            ...
            {notifications.map((notif) => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-white dark:bg-gray-900 rounded-2xl border shadow-card p-4 flex items-start gap-3 cursor-pointer transition-all hover:shadow-card-hover ${
                    !notif.read
