      ...
      <header className="glass-strong border-b border-black/8 shadow-soft flex-shrink-0">
        <div className="max-w-6xl mx-auto px-5 h-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Link href="/register" className="text-xs text-white font-medium px-3 py-1.5 rounded-md bg-blue-600 hover:bg-blue-700 transition-all">
              Create Account
            </Link>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 px-12">
            ...
            <p className="text-blue-200 text-sm mb-10 leading-relaxed">
              Continue building meaningful connections and sharing your ideas with the legal community.
            </p>
