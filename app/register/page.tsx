      ...
      <div className="min-h-screen bg-[#e8ecf0] flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12">
          ...
          >
            ...
            >
              Welcome to Lawsa Socials, <span className="font-semibold text-blue-600">{form.name}</span>!
                ...
                >
                  ...
                  {step === 4 && (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-400 mt-2">You must be at least 13 years old to join Lawsa Socials.</p>
                    </StepWrapper>
                  )}
    ...
    <header className="glass-strong border-b border-black/8 shadow-soft flex-shrink-0">
      <div className="max-w-6xl mx-auto px-4 h-12 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <LogoIcon size={24} />
          <span className="font-semibold text-sm text-gray-800">Lawsa Socials</span>
        </Link>
        <div className="flex items-center gap-2.5">
          <span className="text-xs text-gray-400">Already a member?</span>
          <Link href="/login" className="text-xs font-medium px-3 py-1.5 rounded-md border border-black/10 text-gray-700 hover:border-blue-600 hover:text-blue-600 transition-all">
            Sign In
          </Link>
        </div>
      </div>
