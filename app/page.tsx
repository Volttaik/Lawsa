    ...
    <div className="min-h-screen bg-[#e8ecf0]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="text-base text-gray-500 mb-8 leading-relaxed max-w-xl">
                Lawsa Socials is where students and professionals come together to build meaningful connections, share knowledge, and unlock new opportunities in law and beyond.
              </motion.p>
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-blue-100 text-sm leading-relaxed mb-8">
              Whether you&apos;re a student looking for opportunities, a developer sharing side projects, or a professional mentoring the next generation — Lawsa Socials is your home.
            </motion.p>
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-col justify-center px-10 py-16 bg-white">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-6">
                Lawsa Socials was built for the legal community — law students, attorneys, paralegals, and professionals who want to stay connected, share insights, and advance their careers.
              </p>
      ...
      <section className="relative py-20 px-5 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            {[
              { name: "Sarah K.", role: "Law Student", text: "Lawsa Socials helped me find my first internship through a connection I made on the platform. The community is incredibly supportive!" },
      ...
      <footer className="bg-gray-50 border-t border-black/8 py-10 px-5">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-black/8 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
            <div className="text-xs text-gray-400">© 2025 Lawsa Socials. All rights reserved.</div>
