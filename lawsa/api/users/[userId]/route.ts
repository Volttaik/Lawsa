...
import { getUserById, countPostsByAuthor, countSocialEvents, updateUser } from "@/lib/queries";
...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ userId: string }> }) {
  try {
    ...
    // Use social_events counts when available (non-zero), fall back to array lengths
