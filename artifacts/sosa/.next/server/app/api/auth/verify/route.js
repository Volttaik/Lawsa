"use strict";(()=>{var e={};e.id=571,e.ids=[571],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},8678:e=>{e.exports=import("pg")},79245:(e,t,r)=>{r.a(e,async(e,i)=>{try{r.r(t),r.d(t,{originalPathname:()=>m,patchFetch:()=>c,requestAsyncStorage:()=>p,routeModule:()=>d,serverHooks:()=>f,staticGenerationAsyncStorage:()=>u});var o=r(7849),a=r(94966),s=r(79169),n=r(89984),l=e([n]);n=(l.then?(await l)():l)[0];let d=new o.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/auth/verify/route",pathname:"/api/auth/verify",filename:"route",bundlePath:"app/api/auth/verify/route"},resolvedPagePath:"/home/runner/workspace/artifacts/sosa/app/api/auth/verify/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:p,staticGenerationAsyncStorage:u,serverHooks:f}=d,m="/api/auth/verify/route";function c(){return(0,s.patchFetch)({serverHooks:f,staticGenerationAsyncStorage:u})}i()}catch(e){i(e)}})},89984:(e,t,r)=>{r.a(e,async(e,i)=>{try{r.r(t),r.d(t,{GET:()=>l,dynamic:()=>c});var o=r(1237),a=r(38058),s=r(73067),n=e([a]);a=(n.then?(await n)():n)[0];let c="force-dynamic";async function l(e){try{let t=e.nextUrl.searchParams.get("token");if(!t)return o.NextResponse.redirect(new URL("/email-verified?status=invalid-token",e.url));let r=await (0,a.gF)(t);if(!r)return o.NextResponse.redirect(new URL("/email-verified?status=invalid-token",e.url));if(r.emailVerified)return o.NextResponse.redirect(new URL("/email-verified?status=already",e.url));return await (0,a.Nq)(r.id,{emailVerified:!0,emailVerificationToken:""}),(0,s.Pi)(r.email,r.name,function(e){let t=e.headers.get("x-forwarded-proto")||"https",r=e.headers.get("x-forwarded-host")||e.headers.get("host")||"localhost:5000";return`${t}://${r}`}(e)).catch(()=>{}),o.NextResponse.redirect(new URL("/email-verified?status=success",e.url))}catch(t){return console.error("Verify email error:",t),o.NextResponse.redirect(new URL("/email-verified?status=error",e.url))}}i()}catch(e){i(e)}})},73067:(e,t,r)=>{r.d(t,{L5:()=>c,LS:()=>p,Pi:()=>u,zk:()=>d});var i=r(34449);let o="Sosa",a=null;async function s(e,t=3){let r;for(let s=1;s<=t;s++){let n=function(){if(a)return a;let e=process.env.GMAIL_USER,t=process.env.GMAIL_APP_PASSWORD;return e&&t?((a=i.createTransport({host:"smtp.gmail.com",port:465,secure:!0,auth:{user:e,pass:t},socketTimeout:1e4,greetingTimeout:1e4,connectionTimeout:1e4})).verify().then(()=>{console.log("[email] SMTP connection OK")}).catch(e=>{console.error("[email] SMTP verify failed:",e.message),a=null}),a):(console.error("[email] GMAIL_USER or GMAIL_APP_PASSWORD env vars are missing"),null)}();if(!n)throw Error("Email service is not configured. Please contact the administrator.");try{let t=await n.sendMail({...e,from:`${o} <${process.env.GMAIL_USER}>`});console.log(`[email] Sent "${e.subject}" to ${e.to} — ${t.messageId}`);return}catch(i){r=i,console.error(`[email] Attempt ${s}/${t} failed:`,i.message),a=null;let e=i?.responseCode||0;if(550===e||553===e||535===e||i?.code==="EAUTH")break;s<t&&await new Promise(e=>setTimeout(e,1500*s))}}throw Error(function(e){let t=(e?.message||"").toLowerCase(),r=e?.code||"",i=e?.responseCode||0;return process.env.GMAIL_USER&&process.env.GMAIL_APP_PASSWORD?"EAUTH"===r||535===i||t.includes("invalid credentials")||t.includes("username and password")?"Email service credentials are incorrect. Please contact the administrator.":550===i||553===i||t.includes("does not exist")||t.includes("no such user")||t.includes("invalid address")||t.includes("bad destination")?"That email address doesn't exist or cannot receive mail. Please check and try again.":421===i||450===i||t.includes("daily sending quota")||t.includes("rate limit")||t.includes("too many")?"Email sending limit reached. Please try again later.":"ECONNECTION"===r||"ETIMEDOUT"===r||"ESOCKET"===r||t.includes("connect")||t.includes("timeout")?"Could not connect to the email server. Please try again in a moment.":552===i||t.includes("message too large")?"The email is too large to send.":"Failed to send email. Please try again later.":"Email service is not configured. Please contact the administrator."}(r))}function n(e){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
...
– ${o}`;await s({to:e,subject:`Welcome to ${o}`,html:i,text:a,headers:{"X-Priority":"3","X-Mailer":o,"List-Unsubscribe":`<mailto:${process.env.GMAIL_USER}?subject=unsubscribe>`}})}}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),i=t.X(0,[3867,5444,4449,8058],()=>r(79245));module.exports=i})();